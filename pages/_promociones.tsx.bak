      ...
      <section className="py-10">
        <header className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Descubre nuestras ofertas especiales. Productos con estilos de tarjeta pensados para promociones.
          </p>
        </header>

        {/* Grid de promos tipo productos, con estilo destacado */}
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <article className="rounded-2xl border border-pink-200 bg-pink-50 p-4 shadow-sm">
            ...
            <div className="mt-3">
              ...
              <p className="text-sm text-gray-600">Antes S/ 49.90 • <span className="text-pink-600 font-semibold">Ahora S/ 34.90</span></p>
